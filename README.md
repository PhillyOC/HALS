...
2. Download [`HALS-Setup-1.0.8.exe`](https://github.com/PhillyOC/HALS/releases/latest/download/HALS-Setup-1.0.8.exe)
...
1. Download [`HALS-1.0.8.zip`](https://github.com/PhillyOC/HALS/releases/latest/download/HALS-1.0.8.zip) from [Releases](https://github.com/PhillyOC/HALS/releases/latest)
...
- `HALS-1.0.8\` — clean portable tree
- `HALS-1.0.8.zip` — portable archive
...
This stages the portable tree, compiles `dist\HALS-Setup-1.0.8.exe`, and copies the bootstrap installer scripts into `dist\`.
